...
public class Todo extends TableImpl<TodoRecord> {
    ...
    /**
     * The column <code>public.todo.list_id</code>.
     */
    public final TableField<TodoRecord, Integer> LIST_ID = createField(DSL.name("list_id"), SQLDataType.INTEGER.nullable(false), this, "");
